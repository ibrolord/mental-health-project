...
const s = StyleSheet.create({
  ...
  brand: { color: Colors.text, fontFamily: 'Georgia', fontSize: 24, fontWeight: '700' },
  ...
  date: { color: Colors.accent, ...Typography.eyebrow, marginBottom: Spacing.sm },
  title: { color: Colors.text, ...Typography.display, fontSize: 32, marginBottom: Spacing.sm },
  subtitle: { color: Colors.textSecondary, ...Typography.body, fontSize: 15 },
  attribution: { color: Colors.textSecondary, ...Typography.caption, marginTop: Spacing.xs },
  moodSection: { marginTop: Spacing.lg, marginBottom: Spacing.md },
  ...
  nextStepTitle: { color: Colors.text, ...Typography.display, maxWidth: '68%' },
  nextStepCopy: { color: Colors.textSecondary, ...Typography.body, maxWidth: '62%', marginTop: Spacing.sm },
  nextStepButton: {
