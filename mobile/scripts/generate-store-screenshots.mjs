...
const screens = [
  {
    output: '00_daily_support.png',
    source: 'today.png',
    title: ['Mental-health support', 'for every day.'],
    body: ['Check in, understand your patterns, and take', 'one useful next step.'],
  },
  {
    output: '01_mood.png',
    source: 'mood.png',
    title: ['Understand how', 'you are really doing.'],
    body: ['Name the feeling, add context, and notice', 'patterns over time.'],
  },
  {
    output: '02_together.png',
    source: 'together.png',
    title: ['Stay accountable with', 'someone you trust.'],
    body: ['Share chosen commitments, check in, and', 'celebrate progress together.'],
  },
  {
    output: '03_tools.png',
    source: 'tools.png',
    title: ['Find support that fits', 'what you need now.'],
    body: ['Grounding, reflection, planning, learning,', 'and focus in one toolkit.'],
  },
  {
    output: '04_goals.png',
    source: 'goals.png',
  ...
  {
    output: '05_grounding.png',
    source: 'ground.png',
    title: ['Get grounded when', 'the moment feels heavy.'],
    body: ['Choose what is happening and follow one', 'clear step at a time.'],
  },
  {
