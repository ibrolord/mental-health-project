...
SOURCE_ONLY=0
MIC_PERMISSION="MHtoolkit uses the microphone for voice sessions and voice journal recordings you start. Voice journal audio is saved privately with your entry and sent for transcription only when you choose transcription."
